...
export const data = [
...

  {
    ...
    githubURL: 'https://github.com/esaia/Chat_App',
    img: './images/chat.jpg',
...

  {
    ...
    websiteURL: 'https://github.com/esaia/blog_mysql',
    img: './images/blog.jpg',
    skills: ['NodeJS', 'express', 'mysql', 'sass', 'jwt', 'bcrypt'],
  },

  {
    title: 'Store Ecommerce',
    githubURL: 'https://github.com/esaia/Store',
    websiteURL: 'https://reduxstorerwithreact.netlify.app/',
    img: './images/store.jpg',
    skills: ['Redux', 'redux toolk', 'store', 'pagination'],
  },
...

  {
    ...
    githubURL: 'https://github.com/esaia/Password_generator',
    websiteURL: 'https://esaia.github.io/Password_generator/',
...
export const socialLinks = [
  {
    link: 'https://www.facebook.com/esaia.gafrindashvili/',
    icon: <FaFacebookSquare />,
  },
  { link: 'https://github.com/esaia', icon: <FaGithub /> },
  {
    link: 'https://www.linkedin.com/in/esaia-gaprindashvili-7219771a9/',
    icon: <FaLinkedin />,
  },
];
